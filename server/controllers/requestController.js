...
const acceptFriendRequest = async (req, res) => {
  try {
    ...
    user.friendRequestsReceived = user.friendRequestsReceived.filter(id => id.toString() !== requestId.toString());
    requestSender.friendRequestsSent = requestSender.friendRequestsSent.filter(id => id.toString() !== userId.toString());
