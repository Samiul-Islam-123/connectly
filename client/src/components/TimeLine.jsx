...
import { Story, post, post2, post3, post4, post5, post6, post_img, post_img2, post_img_2, post_img4, heart, comment, share, heart_fill } from '../app/assets';
        ...
        <>
            <div className='flex flex-col gap-5 py-2'>
                ...
                <div className='bg-white w-[760px] h-auto rounded-xl px-5 py-2'>
                    ...
                    <div className='flex justify-between items-center'>
                        <div className='flex gap-5 items-center'>
                            <p onClick={handleLike} className='flex items-center gap-2'><Image width={22} src={heart_fill} /> Like</p>
