                ...
                >
                    <div className="py-3 px-1">
                        ...
                        <div id="menu" className="flex flex-col gap-2">
                            ...
                            <Link href={'/'} className='font-medium py-2 px-2 hover:bg-[#FF578E] hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out hover:no-underline flex items-center gap-2'><Image src={feed} className='text-black w-5 h-5' /> Feeds</Link>
